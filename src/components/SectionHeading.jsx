export default function SectionHeading({ title, subtitle, as: HeadingTag = "h2" }) {
  return (
    <div className="mb-10 lg:mb-16">
      ...
      <HeadingTag className="text-3xl sm:text-5xl font-black text-funeka-anchor uppercase tracking-tighter leading-none">
        {title}
      </HeadingTag>
      {subtitle ? (
