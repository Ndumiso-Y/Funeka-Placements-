...
export default function WhatsAppFloatingButton() {
  ...
  const buttonElement = (
    <a
      ...
      className="whatsapp-btn flex items-center justify-center bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-[transform,background-color,box-shadow] duration-200 hover:scale-105 w-12 h-12 sm:w-auto sm:h-auto sm:gap-2 sm:px-5 sm:py-3.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#25D366]"
    >
      {/* WhatsApp SVG Icon */}
      <svg
